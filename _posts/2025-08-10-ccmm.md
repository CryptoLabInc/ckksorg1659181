...
<div class="row mt-3">
    <div class="col-sm-10 mt-3 mt-md-0 mx-auto d-block">
        {% include figure.liquid loading="eager" path="assets/img/blog/2508_JaiHyun/PC-MM.jpg" class="img-fluid rounded" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm-9 mt-3 mt-md-0 mx-auto d-block">
        {% include figure.liquid loading="eager" path="assets/img/blog/2508_JaiHyun/C-MT.jpg" class="img-fluid rounded" zoomable=true %}
    </div>
</div>
...
{% include figure.liquid loading="eager" path="assets/img/blog/2508_JaiHyun/CC-MM.jpg" class="img-fluid rounded" zoomable=true %}
