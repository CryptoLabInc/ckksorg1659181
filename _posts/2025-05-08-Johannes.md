...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/250508_Johannes/1.png" class="img-fluid rounded z-depth-1" oomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/250508_Johannes/2.png" class="img-fluid rounded z-depth-1" oomable=true %}
    </div>
</div>
<div class="caption">
...
## FAQ: What is homomorphic encryption?
