...
### Benchmark
With the above technique, we instantiate the first ZKAoK for CKKS ciphertexts[^6] that can verify the input domain. Below, we provide concrete benchmark results for the ZKAoK, which verifies that input messages lie in $[-1, 1]^N$. The benchmark is measured on an Intel Xeon Platinum 8268 CPU with a single thread.
<div style="margin-top: 1.5em;"></div>
...
## References
<div style="margin-top: 1.5em;"></div>
[^1]: Albrecht, Martin R., et al. "Crypto dark matter on the torus: Oblivious prfs from shallow prfs and tfhe." Eurocrypt 2024.
[^2]: Dwork, Cynthia, and Vitaly Feldman. "Privacy-preserving prediction." COLT 2018.
[^3]: Hwang, Intak, et al. "On the Security and Privacy of CKKS-based Homomorphic Evaluation Protocols." Asiacrypt 2025.
